...
class Members():
    ...
    async def set_welcome(ctx, mesg1, mesg2):
    ...
    async def on_member_remove(member):
        em = discord.Embed(title=f"{member.metion} joined!", description="mesg2", colour=0x3498db)
        em.set_thumbnail(url="https://cdn.discordapp.com/emojis/421004865049985035.png?v=1")
